---
name: draft
description: "Draft academic prose for philosophy or humanities papers with proper scholarly apparatus. Use when the user wants to write, draft, or outline a paper, thesis chapter, or journal article. Supports analytic, continental, and comparative philosophy structures. Triggers: 論文撰寫, 起草, draft, write paper, write my introduction, 幫我寫, outline my argument, argument skeleton, conceptual analysis, 概念分析, hermeneutics, 詮釋, 解讀, dialectics, 辯證, comparative philosophy, 比較哲學."
---
...
2. **Section-by-section drafting**: Work through one section at a time:
   - Brainstorm 5-15 points for the section
...
**Analytic Philosophy:**
1. Introduction (question + thesis + roadmap)
2. Background / Key Concepts
3. Main Argument (with sub-arguments)
4. Objections & Responses
5. Conclusion (implications + further questions)

**Continental Philosophy:**
1. Introduction (problem situation + hermeneutic entry point)
2. Textual Analysis / Phenomenological Description
3. Interpretive Development
4. Critical Engagement with Secondary Literature
5. Conclusion (implications for understanding)

**Comparative Philosophy:**
1. Introduction (problem + justification for comparison + thesis)
2. Methodological Framework
3. Tradition A Analysis (in its own terms)
4. Tradition B Analysis (in its own terms)
5. Comparative Analysis (convergence, divergence, new insight)
6. Conclusion
...
| [examples.md](../../references/examples.md) | Read 案例四 for a full demonstration of the skeleton-first drafting process |
